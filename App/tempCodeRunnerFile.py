...
import joblib
import io
import os # <--- Bổ sung thư viện này
...
# --- MAP TÊN MÔ HÌNH VỚI FILE PKL (DÙNG ĐƯỜNG DẪN TUYỆT ĐỐI) ---
model_paths = {
    "LightGBM": os.path.join(BASE_DIR, "Model", "lgb_model.pkl"), 
    "Random Forest": os.path.join(BASE_DIR, "Model", "random_fr.pkl"),
    "Cây Quyết Định": os.path.join(BASE_DIR, "Model", "decision_tree_optimal_model.pkl"),
    "Hồi quy Logistic": os.path.join(BASE_DIR, "Model", "logistic_regression_model.pkl")
}
        ...
        with st.spinner('Hệ thống đang xử lý dữ liệu...'):
            try:
                ...
                if model_choice == "Hồi quy Logistic":
                    # Khai báo đường dẫn tuyệt đối cho Scaler
                ...
                # 5. Gắn kết quả trả lại Dataframe
